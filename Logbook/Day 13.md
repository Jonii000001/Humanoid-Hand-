...
I also found out that the MT6701 is smaller, so if the AS5048 will still be too big, then I have to take the MT6701. After I knew which sensor I'll take, I started to design the circuit board (AS5048, because I think it more known, because of the AS-series).

Today I also connected all of the CAD parts, which I designed so far and looked for colliding passages. I've fixed a bit quite now, but not all.

In addition, I looked this day which pressure sensor I'll use for the feeling of the fingertips and I will probably take the FSR x400 short sensor, because it has a high quality and good controlling.
